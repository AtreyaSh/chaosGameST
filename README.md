...
Here we present a nice gif of this chaos game. The iterations range from 1-100 with a step of 1. Then, the iterations jump from 500-10,000; with steps of 500. This is done to speed up the visualization process.
